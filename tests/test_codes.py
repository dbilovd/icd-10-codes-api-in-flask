...
class CodesTest(unittest.TestCase):
    ...
    def test_it_returns_a_200_status_code(self):
        response = self.client().get("/codes/")
        self.assertEqual(response.status_code, 200)

    def test_it_returns_any_codes_available(self):
    ...
    def test_it_returns_a_paginated_set_of_20_codes(self):
    ...
    def test_it_allows_for_fetching_a_particular_paginated_page(self):
        CodeFactory.create_batch(21)
    ...
    def test_it_returns_a_404_error_code_for_a_page_that_does_not_exists(self):
        CodeFactory.create_batch(2)

        response = self.client().get("/codes/?page=2")
        self.assertEqual(response.status_code, 404)

    def test_it_can_retrieve_an_existing_code(self):
        code = CodeFactory.create()
        code.save()

        response = self.client().get(f'/codes/{code.id}')
        self.assertEqual(response.status_code, 200)
        response_json = response.json
    ...
    def test_it_creates_a_new_code_in_db(self):
    ...
    def test_it_can_create_a_new_code_in_with_a_parent_id(self):
    ...
    def test_it_returns_a_400_error_for_missing_code_in_request(self):
        code = CodeFactory.build()
    ...
    def test_it_returns_a_400_error_for_missing_title_in_request(self):
        code = CodeFactory.build()
    ...
    def test_it_returns_a_404_error_for_a_codeid_that_does_not_exist(self):
    ...
    def test_it_can_update_an_existing_code_record(self):
        code = CodeFactory.create()
        code_code = code.code
    ...
    def test_it_can_remove_a_record_from_the_database(self):
        code = CodeFactory.create()
        code.save()
